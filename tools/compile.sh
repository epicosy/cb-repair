...
if [ "$#" -ne 1 ]
then
	echo "Usage: ./compile.sh challenge_name"
	exit 1
fi
...
CMAKE_OPTS="${CMAKE_OPTS} -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_CXX_OUTPUT_EXTENSION_REPLACE=ON"
...
cmake $CMAKE_OPTS .. -DCB_PATH:STRING=$1
